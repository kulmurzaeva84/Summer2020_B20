...
public class Util {
    //   import Library.Util; place between package and class
    ...
    public static String removeDup(String str){
        ...
        return nonDup;
    } // removes the duplicates and returns the value of string
    ...
    public static int frequency(String str, char ch){ // finds the frequency of char from string str
        ...
        return count;
    } // finds frequency of char from string and returns it as int
    ...
    } // returns frequency of every single char from string
    ...
    public static int maxNum(int[] arr){
        ...
        for( int each : arr ){
           ...
           return max;
    } // finds and returns Max Number from the int array
    ...
    }// finds and returns Max Number from the Integer array
    ...
    } // finds and returns Max Number from the double array
    ...
    public static int minNum(int[] arr){
        ...
        return min;
    } // finds and returns Min Number from the int array
    ...
    public static double minNum(double[] arr){
        ...
        return min;
    }  // finds and returns Min Number from the double array
    ...
    public static Integer minNum(Integer[] arr){
        ...
        return min;
    }  // finds and returns Min Number from the Integer array
    ...
    public static int[] addElement(int[] arr, int num){
        ...
        return arr2;
    } // inserts the element to the array from day32/addElement

    // double, Double, Integer, char, Character, String
    ...
    public static int[] sortDesc(int[] arr){
        ...
        return arr2;
    }  // sorts int array in descending order and returns value
    ...
    public static double[] sortDesc(double[] arr){
        ...
        return arr2;
    }  // sorts double array in descending order and returns value
    ...
    public static char[] sortDesc(char[] arr){
        ...
        return arr2;
    }  // sorts char array in descending order and returns value
    ...
    public static String[] sortDesc(String[] arr){
        ...
        return arr2;
    }  // sorts String array in descending order and returns value
    ...
    public static Integer[] sortDesc(Integer[] arr){
        ...
        return arr2;
    } // sorts Integer array in desc order and returns value
    ...
    public static Double[] sortDesc(Double[] arr){
        ...
        return arr2;
    } //sorts Double array in desc order and returns value
    ...
    public static Character[] sortDesc(Character[] arr){
        ...
        return arr2;
    }  //sorts Character array in desc order and returns value
